...
ggplot(qqplot_commitment, aes(sample = commitment_latency)) +
  ...
  stat_qq_line() +
  ggtitle("Commitment latency, lognormal quantiles")

ggplot(qqplot_helping, aes(sample = helping_latency)) +
  stat_qq(distribution = stats::qlnorm) +
  stat_qq_line() +
  ggtitle("Helping latency, lognormal quantiles") 
...
post_prob_commit121314 <- tibble(post_prob = post_prob(commit_glmm12, commit_glmm13, commit_glmm14))
BF_commit_takeleave <- post_prob_commit121314$post_prob[[3]]/post_prob_commit121314$post_prob[[2]]
...
post_prob_sharing234 <- tibble(post_prob = post_prob(sharing_glmm2, sharing_glmm3, sharing_glmm4))
BF_share <- post_prob_sharing234$post_prob[[1]]/post_prob_sharing234$post_prob[[2]]
...
##Table 4
table_commit_glmm1 <- fixef(commit_glmm1)
